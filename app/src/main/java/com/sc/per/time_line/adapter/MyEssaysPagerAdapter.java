 ...
 * 随笔界面适配器
 */
public class MyEssaysPagerAdapter extends PagerAdapter {
    ...
    public MyEssaysPagerAdapter(Context context, ArrayList<TabDetailPager> tabDetailPagers, List<Menu> menu) {

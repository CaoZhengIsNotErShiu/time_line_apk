...
public class Article {
    ...
    public static class DataBean {
        ...
        public static class ListBean {
             ...
             * data : 1.添加依赖&lt;dependency&gt;   &lt;groupId&gt;org.springframework.boot&lt;/groupId&gt;   &lt;artifactId&gt;spring-boot-starter-login&lt;/artifactId&gt;   &lt;scope&gt;login&lt;/scope&gt;&lt;/dependency&gt;2.创建测试文件夹, 注意该测试java程序虽然和应用程序入口的java文件不在一个目录下, 但它们是同一个package. 3.创建测试类
             * comments : 0
             * likenum : 0
             * userLikeNum : 0
             * firstMenu : null
